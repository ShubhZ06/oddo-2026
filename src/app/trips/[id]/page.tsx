    ...
    <div className="flex flex-col gap-6 max-w-[1100px] mx-auto animate-fade-in">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 flex flex-col gap-6">
          <div className="bg-bg-secondary border border-border rounded-xl p-6 flex flex-col gap-6">
            ...
            <div className="flex flex-col md:flex-row gap-6 justify-between bg-white/2 border border-border/60 rounded-xl p-5">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <span className="font-semibold text-text">{trip.source}</span>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <span className="font-semibold text-text">{trip.destination}</span>
                </div>
              </div>
            </div>
            ...
            <div className="border-t border-border/80 pt-6 flex flex-wrap gap-x-8 gap-y-3 text-xs text-text-muted">
          ...
          <div className="bg-bg-secondary border border-border rounded-xl p-6">
            ...
            {(!trip.expenses || trip.expenses.length === 0) ? (
              <div className="p-8 border border-dashed border-border rounded-xl text-center text-text-secondary text-xs flex flex-col items-center gap-2 bg-white/1">
              ...
              <div className="flex flex-col gap-3">
                {trip.expenses.map((expense: any) => (
                  <div key={expense.id} className="flex justify-between items-center p-3 rounded-lg bg-white/2 border border-border/50 text-xs">
                    <div>
            ...
            {trip.vehicle ? (
              <div className="flex flex-col gap-2">
                <Link
                  ...
                  className="font-bold text-sm text-text hover:text-primary-light transition-colors"
                >
        ...
        footer={
          <>
            <button
              ...
              className="px-4 py-2 text-sm font-semibold border border-border rounded-lg hover:bg-white/5 transition-colors cursor-pointer text-text-secondary hover:text-text"
            >
              Back
            </button>
            <button
      ...
      >
        <form onSubmit={handleCompleteSubmit} className="flex flex-col gap-4">
          <div className="bg-white/2 border border-border p-4 rounded-xl flex items-center gap-3 text-xs text-text-secondary">
            <Info size={16} className="text-primary-light shrink-0" />
            <div>
              Starting Odometer: <span className="font-semibold text-text">{trip.vehicle?.odometerKm} km</span>.
          ...
          <div className="flex flex-col gap-2">
            ...
            <input
              ...
              required
              className={`w-full bg-bg border rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:ring-1 transition-all text-text ${
                odometerError
          ...
          <div className="flex flex-col gap-2">
            ...
            <input
              ...
              min="0.1"
              step="any"
              className="w-full bg-bg border border-border rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:border-primary-light focus:ring-1 focus:ring-primary-light transition-all text-text"
            />
          </div>
        </form>
      </Modal>
