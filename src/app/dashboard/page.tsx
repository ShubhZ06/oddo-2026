  ...
  return (
    <div className="flex flex-col gap-6 animate-fade-in">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3 bg-surface-secondary p-1.5 rounded-lg border border-border-default-default-default">
          <select className="bg-transparent text-sm px-3 py-1.5 focus:outline-none border-r border-border-default-default-default">
        ...
        <div className="bg-surface-secondary border border-border-default-default-default rounded-xl p-6 flex flex-col items-center justify-center">
          ...
          <div className="w-full h-[250px] relative">
             ...
             <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none mt-4">
                ...
                <span className="text-xs text-text-primary-primary-primary-muted">Total Fleet</span>
             </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-3 bg-surface-secondary border border-border-default-default-default rounded-xl p-6">
          ...
          <div className="flex flex-col gap-4">
            {RECENT_ACTIVITY.map((activity) => (
              <div key={activity.id} className="flex items-start gap-4 p-4 rounded-lg bg-white/3 border border-border-default-default-default transition-colors hover:bg-white/5">
