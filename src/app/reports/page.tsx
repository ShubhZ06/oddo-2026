    ...
    <div className="flex flex-col gap-6 animate-fade-in max-w-[1400px] mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-text-secondary text-sm">Analyze your fleet's performance and expenses.</p>
        </div>
        ...
        <div className="flex items-center gap-3">
          <div className="flex items-center gap-2 bg-bg-secondary p-1.5 rounded-lg border border-border">
            ...
            <select 
              ...
              className="bg-transparent text-sm px-2 py-1.5 focus:outline-none border-r border-border cursor-pointer text-text"
            >
            ...
            <select 
              ...
              className="bg-transparent text-sm px-2 py-1.5 focus:outline-none cursor-pointer text-text"
            >
          ...
          <button className="flex items-center gap-2 px-4 py-2.5 bg-bg-secondary border border-border rounded-lg text-sm font-medium hover:bg-bg-card-hover transition-colors">
            <Download size={16} />
            Export CSV
          </button>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-3 bg-bg-secondary border border-border rounded-xl p-6">
          <div className="mb-4">
            ...
            <p className="text-xs text-text-muted">Financial performance over {dateRange.toLowerCase()}</p>
          </div>
        ...
        <div className="lg:col-span-2 bg-bg-secondary border border-border rounded-xl p-6">
          <div className="mb-4">
            ...
            <p className="text-xs text-text-muted">Distribution of costs by category</p>
          </div>
        ...
        <div className="bg-bg-secondary border border-border rounded-xl p-6 flex flex-col">
          <div className="mb-4">
            ...
            <p className="text-xs text-text-muted">Overall vehicle status</p>
          </div>
