...
export default function Sidebar() {
  ...
  return (
    <aside className="fixed left-0 top-0 bottom-0 w-64 bg-surface-secondary border-r border-border-default-default-default flex flex-col animate-fade-in z-40">
      <div className="h-16 flex items-center px-6 border-b border-border-default-default-default shrink-0">
      ...
      <div className="flex-1 overflow-y-auto py-6 px-4 flex flex-col gap-1">
        <div className="text-xs font-semibold text-text-primary-primary-primary-muted uppercase tracking-wider mb-2 px-3">
          Menu
        </div>
            ...
            <Link
              ...
              className={`flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-colors ${
                isActive
                  ...
                  : "text-text-primary-primary-primary-secondary hover:bg-white/5 hover:text-text-primary-primary-primary"
              }`}
            >
